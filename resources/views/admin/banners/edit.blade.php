        ...
        <div class="p-6">
            ...
            <form action="{{ route('admin.banners.update', $banner) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-4">
                    ...
                    @if($banner->image)
                        <div class="mb-3">
                            ...
                            <img src="{{ asset('storage/' . $banner->image) }}" 
                                 alt="Current Banner" 
                                 class="w-48 h-28 object-cover rounded border shadow-sm">
                        </div>
                    @endif
                    ...
                    <p class="text-gray-500 text-xs mt-1">Format: JPEG, PNG, JPG, GIF, WEBP. Maksimal 5MB. Kosongkan jika tidak ingin mengubah gambar.</p>
