...
<div class="container mx-auto px-4 py-8">
    <div class="max-w-2xl mx-auto bg-white rounded-lg shadow-lg p-8">
        <h1 class="text-3xl font-bold text-gray-800 text-center mb-8">Add New Address</h1>
        ...
        <form method="POST" action="{{ route('addresses.store') }}" id="addressForm">
            @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                <div>
                    ...
                    <input type="hidden" id="provinsi_name" name="provinsi_name" value="{{ old('provinsi_name') }}">
                    @error('provinsi')
                        <div class="text-red-600 text-sm mt-1">{{ $message }}</div>
                    @enderror
                </div>
