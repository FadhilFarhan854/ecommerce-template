    ...
    <div class="container mx-auto px-4 py-6">
        ...
        <nav class="text-sm text-gray-600 mb-4">
            <ol class="flex items-center space-x-2">
                ...
                <li><a href="{{ route('products.catalog') }}" class="hover:text-blue-600">Produk</a></li>
                <li><span class="text-gray-400">/</span></li>
                <li><a href="{{ route('products.catalog', ['category' => $product->category->name]) }}" class="hover:text-blue-600">{{ $product->category->name }}</a></li>
                <li><span class="text-gray-400">/</span></li>
                ...
                <div class="lg:col-span-7">
                    ...
                    <div class="mb-6">
                        <div class="flex items-center space-x-2">
                            ...
                            <a href="{{ route('products.catalog', ['category' => $product->category->name]) }}" 
